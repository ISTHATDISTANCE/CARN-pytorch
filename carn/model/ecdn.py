...
class Transition(nn.Module):
    def __init__(self, nChannels, nOutChannels):
        ...
        self.bn = nn.BatchNorm2d(nChannels)
        self.conv = nn.Conv2d(nChannels, nOutChannels, kernel_size=1)
...
def DenseBlock(growthRate, nChannels, nOutChannels, nDenseLayers):
    layers = []
    for i in range(nDenseLayers):
        layers.append(DenseLayer(nChannels, growthRate))
        nChannels += growthRate
    layers.append(Transition(nChannels, nOutChannels))
...
class Net(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.b1 = DenseBlock(16, 64, 64, 8)
        self.b2 = DenseBlock(16, 64, 64, 8)
        self.b3 = DenseBlock(16, 64, 64, 8)
